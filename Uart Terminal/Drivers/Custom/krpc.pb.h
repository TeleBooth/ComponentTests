...
#define krpc_schema_Procedure_init_default       {{{NULL}, NULL}, {{NULL}, NULL}, krpc_schema_Type_init_default, 0, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define krpc_schema_Procedure_init_zero          {{{NULL}, NULL}, {{NULL}, NULL}, krpc_schema_Type_init_zero, 0, {{NULL}, NULL}, {{NULL}, NULL}}
...
extern const pb_field_t krpc_schema_ProcedureCall_fields[4];
...
#define krpc_schema_Request_size                 (7 + 1*krpc_schema_ProcedureCall_size)
...
#define krpc_schema_MultiplexedRequest_size      (19 + krpc_schema_ConnectionRequest_size + 1*krpc_schema_ProcedureCall_size)
